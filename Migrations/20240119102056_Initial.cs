    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2024, 1, 19, 12, 20, 55, 849, DateTimeKind.Local).AddTicks(8183), "Продам телефон Redmi 9A в гарному стані на фото видно що має незначні царини роботі вони не впливають а загалом він як новий .", false, 1500m, "Олександр", "Телефон REDMI 9A" },
                    { 2, 2, 2, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5191), "Ніяких mdm блокувань немає. Ноутбук без жодних дефектів і повний комплект(зарядка, коробка, шнур, макулатура і наклейки). Фото коробки і інших дрібниць не кидаю але все маю, нічого не викидав.", false, 99900m, "Михайло", "MacBook M1 Max 14” 64RAM/32GPU/2Tb ssd" },
                    { 3, 3, 3, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5228), "Смарт тв 32” Samsung UE32T4510AUXUA, Smart TV, WiFi, T2. Телевізор білого кольору, 2021 року виробництва.Телевізор в ідеальному стані та повному комплекті, - пульт, ніжнки. Усе в оригіналі, всі функції перевірені та працюють", false, 7900m, "Микола", "Смарт тв 32” Samsung UE32T4510AUXUA, Smart TV, WiFi, T2" },
                    { 4, 4, 4, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5233), "Продам полностью рабочую в отличном состоянии игровую видеокарту AMD RX 5700XT 8GB GDDR6 ASUS.Температура отличная, без каких либо проблем.Проходит тесты ОССТ/FurMark/3DMark без проблем.Потянет большинство популярных игр на хороших настройках графики!", false, 8500m, "Олена", "Как новая! Видеокарта AMD RX 5700XT 8GB GDDR6 Гарантия!" },
                    { 5, 5, 5, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5236), "Intel i5 7400, причина продажу апгрейд, комплектаці BOX, любі тести, також можна купити комплектом, дивіться інші мої оголошення)комплектом віддам за 5к", false, 1500m, "Ольга", "Процессор intel i5 7400" },
                    { 6, 6, 6, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5239), "Продам оперативну пям'ять SAMSUNG 8 GB. SODIMM. DDR-4. 2400 MHz.Планки по 4GB.Були в роботі 1 рік.", false, 1000m, "Володимир", "Оперативна пям'ять DDR-4 2400 MHz" },
                    { 7, 7, 7, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5242), "Продам тихий игровой компьютер, в хорошем исполнении, с качественных комплектующих, с запасом на апгрейд. Любые проверки и тесты , предпочтительно по месту! Компьютер будет радовать своего нового владельца высокой продуктивностью, и ждет именно вас!", false, 14700m, "Антон", "Silens! Игровой компьютер I5 9400f, z390, gtx 1070 8 gb,16 gb" },
                    { 8, 8, 8, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5246), "Все летает , новые игры без проблем на ультрах! Battlefield 2042, Call of Duty Modern Warfare прошел 3 части!", false, 23500m, "Іван", "Игровой компютер, комплект! GTX 1080, монитор MSI 244 герц!" },
                    { 9, 9, 9, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5249), "Все летает , новые игры без проблем на ультрах! Battlefield 2042, Call of Duty Modern Warfare прошел 3 части!", true, 50m, "Роман", "Зовнішня звукова карта USB 5.1 для комп'ютера та ноутбука (Внешняя)" },
                    { 10, 10, 10, new DateTime(2024, 1, 19, 12, 20, 55, 852, DateTimeKind.Local).AddTicks(5252), "Продаю свою GoPro 10 так як перейшов на новішу модель . Завжди була в захисних склах і у захиснобу силіконовому чохлі , не топилась (Використовувалась як влогова камера ) можлива зустріч у Києві (правий берег ) або Олх доставка/наложка Торг !!!", true, 8000m, "Сергій", "Пртдам Gopro 10 black в дуже горошому стані !!!" }
                });
