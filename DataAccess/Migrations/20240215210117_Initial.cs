    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "028582c83a914a45b330b5234f4131fb", 0, new DateTime(1999, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "7983942f-2d55-44d3-91a4-4859eadc5159", "User3@gmail.com", true, false, null, "Олег", null, "USER3@GMAIL.COM", "AQAAAAIAAYagAAAAEM4Ybu3Oc058z4p0v3EXbmYFtbnofIyyL8fwkTwXF2cOmlLhks+q9V2E9dOI84Os4A==", null, false, "29beb920-3d51-42e2-a799-a97a75f7cca0", "Панасенко", false, "User3@gmail.com" },
                    { "c86dc56aedf549f6afe5ceb4d414ebf1", 0, new DateTime(2000, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "237323b4-fd33-46df-95d1-613a599776fc", "User2@gmail.com", true, false, null, "Петро", null, "USER2@GMAIL.COM", "AQAAAAIAAYagAAAAEEslJiTrj2DO+vhxrE9UN2M08BiZmbEi7MJBSZLzFn6mD3NawKYdMjde0PNLpbC90A==", null, false, "abb8acf8-d395-4c34-a184-6dad614c910d", "Дякуленко", false, "User2@gmail.com" },
                    { "d1901b2435594da2a255db13fc57509b", 0, new DateTime(1988, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "46a5484a-3aeb-47c5-8a52-246cd338d52d", "User1@gmail.com", true, false, null, "Iван", null, "USER1@GMAIL.COM", "AQAAAAIAAYagAAAAEF2OLEih37TxcC0PRCETcydCrHcHkuXprWJUKnLjhxNDsWc1PyDf7bWvIfllQmaFPw==", null, false, "e99fba37-4b3a-4e66-a787-a201eccc8b5b", "Калита", false, "User1@gmail.com" },
                    { "eb05f9548a2c4cf8adcc2be7305fc732", 0, new DateTime(2001, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "d6ab739d-01f5-4af5-9a1e-f04df937dcc8", "User4@gmail.com", true, false, null, "Тимофій", null, "USER4@GMAIL.COM", "AQAAAAIAAYagAAAAEPVj4748VxeOHgko1Qlbi7HClPpJlZ81uvN0omO3Br0uCIGCFYMqerBoYb+sHnQJFA==", null, false, "763f7ce4-c1f3-4179-8eeb-75caa8c882a4", "Гнатенко", false, "User4@gmail.com" },
                    { "f66e492517d7414495e988c4c50fd107", 0, new DateTime(1998, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "cdae4c79-7a76-45e5-9a8d-7bb326874657", "Admin@gmail.com", true, false, null, "Петро", null, "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEKR0EMPE0IPBrnHCq80hzKEsMpMFCUHc6W9IC3asxuxakKNrmOdpEkSc6r4zaDeiKA==", null, false, "21aab1cc-479a-4f81-bfc8-cb580b095287", "Левак", false, "Admin@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2024, 2, 15, 23, 1, 15, 856, DateTimeKind.Local).AddTicks(7531), "Продам телефон Redmi 9A в гарному стані на фото видно що має незначні царини роботі вони не впливають а загалом він як новий .", false, 1500m, "Телефон REDMI 9A", "d1901b2435594da2a255db13fc57509b" },
                    { 2, 2, 1, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6077), "Ніяких mdm блокувань немає. Ноутбук без жодних дефектів і повний комплект(зарядка, коробка, шнур, макулатура і наклейки). Фото коробки і інших дрібниць не кидаю але все маю, нічого не викидав.", false, 99900m, "MacBook M1 Max 14” 64RAM/32GPU/2Tb ssd", "d1901b2435594da2a255db13fc57509b" },
                    { 3, 3, 3, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6123), "Смарт тв 32” Samsung UE32T4510AUXUA, Smart TV, WiFi, T2. Телевізор білого кольору, 2021 року виробництва.Телевізор в ідеальному стані та повному комплекті, - пульт, ніжнки. Усе в оригіналі, всі функції перевірені та працюють", false, 7900m, "Смарт тв 32” Samsung UE32T4510AUXUA, Smart TV, WiFi, T2", "c86dc56aedf549f6afe5ceb4d414ebf1" },
                    { 4, 4, 3, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6131), "Продам полностью рабочую в отличном состоянии игровую видеокарту AMD RX 5700XT 8GB GDDR6 ASUS.Температура отличная, без каких либо проблем.Проходит тесты ОССТ/FurMark/3DMark без проблем.Потянет большинство популярных игр на хороших настройках графики!", false, 8500m, "Как новая! Видеокарта AMD RX 5700XT 8GB GDDR6 Гарантия!", "c86dc56aedf549f6afe5ceb4d414ebf1" },
                    { 5, 5, 5, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6135), "Intel i5 7400, причина продажу апгрейд, комплектаці BOX, любі тести, також можна купити комплектом, дивіться інші мої оголошення)комплектом віддам за 5к", false, 1500m, "Процессор intel i5 7400", "028582c83a914a45b330b5234f4131fb" },
                    { 6, 6, 5, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6140), "Продам оперативну пям'ять SAMSUNG 8 GB. SODIMM. DDR-4. 2400 MHz.Планки по 4GB.Були в роботі 1 рік.", false, 1000m, "Оперативна пям'ять DDR-4 2400 MHz", "028582c83a914a45b330b5234f4131fb" },
                    { 7, 7, 7, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6144), "Продам тихий игровой компьютер, в хорошем исполнении, с качественных комплектующих, с запасом на апгрейд. Любые проверки и тесты , предпочтительно по месту! Компьютер будет радовать своего нового владельца высокой продуктивностью, и ждет именно вас!", false, 14700m, "Silens! Игровой компьютер I5 9400f, z390, gtx 1070 8 gb,16 gb", "eb05f9548a2c4cf8adcc2be7305fc732" },
                    { 8, 8, 7, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6149), "Все летает , новые игры без проблем на ультрах! Battlefield 2042, Call of Duty Modern Warfare прошел 3 части!", false, 23500m, "Игровой компютер, комплект! GTX 1080, монитор MSI 244 герц!", "eb05f9548a2c4cf8adcc2be7305fc732" },
                    { 9, 9, 7, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6153), "Все летает , новые игры без проблем на ультрах! Battlefield 2042, Call of Duty Modern Warfare прошел 3 части!", true, 50m, "Зовнішня звукова карта USB 5.1 для комп'ютера та ноутбука (Внешняя)", "eb05f9548a2c4cf8adcc2be7305fc732" },
                    { 10, 10, 5, new DateTime(2024, 2, 15, 23, 1, 15, 860, DateTimeKind.Local).AddTicks(6158), "Продаю свою GoPro 10 так як перейшов на новішу модель . Завжди була в захисних склах і у захиснобу силіконовому чохлі , не топилась (Використовувалась як влогова камера ) можлива зустріч у Києві (правий берег ) або Олх доставка/наложка Торг !!!", true, 8000m, "Пртдам Gopro 10 black в дуже горошому стані !!!", "028582c83a914a45b330b5234f4131fb" }
                });
